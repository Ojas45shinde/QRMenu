      ...
      <div class="card__body">
        ...
        <div class="form-group">
          ...
          <textarea name="description" class="form-control" rows="3"
                    placeholder="Short description">{{ form.instance.description }}</textarea>
        </div>
        ...
        <div class="form-group">
          ...
          <textarea name="address" class="form-control" rows="2"
                    placeholder="Restaurant address">{{ form.instance.address }}</textarea>
        </div>
        ...
        <div class="form-group">
          ...
          <div style="display:flex;align-items:center;gap:1rem;">
            <input type="color" name="theme_color" id="colorpick"
                   ...
                   style="width:60px;height:44px;padding:0.2rem;">
            <div id="colorpreview"
...
with open(r'C:\Users\acer\Desktop\QRmenu\templates\restaurants\restaurant_form.html', 'w', encoding='utf-8') as f:
    f.write(data)
